...
export function encodeActionSetPluginConfig(params: ProposalConfig): Uint8Array {
...
function unwrapSetPluginConfig(params: ProposalConfig): [BigNumber, BigNumber, BigNumber] {
  return [
