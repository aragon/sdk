...
The `TokenVoting` plugin ensures only token holders are able to vote on proposals.
Tokens created by the TokenVoting plugin follow OpenZeppelin's ERC20Votes standard: https://docs.openzeppelin.com/contracts/4.x/api/token/erc20#ERC20Votes
